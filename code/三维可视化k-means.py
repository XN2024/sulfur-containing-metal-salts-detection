...
kmeans1 = KMeans(n_clusters =numclass, init = 'k-means++', random_state = 0,n_init= 'auto').fit_predict(UV_NEW)
kmeans2 = KMeans(n_clusters =numclass, init = 'k-means++', random_state = 0,n_init= 'auto').fit_predict(FL_NEW)
...
ax.set_zticks(ticks)
ax.set_zticks(ticks)
handles = [ax1, ax2, ax3, ax4,ax5, ax6, ax7, ax8,ax9]
ax.legend(handles=handles,labels=list('abcdefghij'), mode="expand", ncol = 4, borderaxespad = 0)
