...
df = pd.read_excel('混合离子UV+FL选择性指纹图SO32-：SO42-.xlsx')
savefilename='final_fig/混合离子UV+FL选择性指纹图SO32-：SO42-_1.png'
UV_weight=1
...
handles = [ax0,ax1, ax2, ax3, ax4,ax5,ax6, ax7, ax8, ax9,ax10]
